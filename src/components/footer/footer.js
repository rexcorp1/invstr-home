  ...
  return (
    <Box className="footer-background">
        ...
        <Container maxWidth="lg" className="footer-CTA-move">
          <Box className="footer-CTA-background">
            ...
            <Grid md={12} xs={12} style={{ paddingBottom: 25 }}>
              <Link>
                <StaticImage
                  src="./images/icons/LandX-PlayStore.webp"
                  height={130}
                  quality={95}
              ...
              <Link>
                <StaticImage
                  src="./images/icons/LandX-AppStore.webp"
                  height={130}
                  quality={95}
                  formats={["auto", "webp", "avif"]}
                  alt="LandX Platform Equity Crowdfunding Indonesia yang akan membantu investasi bisnis jangka panjang anda"
      ...
      <Container maxWidth="lg" style={{ textAlignLast: `center`, paddingTop: `11rem`, paddingBottom: `3rem` }} >
        ...
        <StaticImage
          src="./images/icons/LandX-OJK.webp"
          height={300}
          quality={95}
          formats={["auto", "webp", "avif"]}
          alt="LandX Platform Equity Crowdfunding Indonesia yang akan membantu investasi bisnis jangka panjang anda"
        ...
        <Grid container spacing={2} style={{ marginTop: `5rem`, marginBottom: `4rem`, textAlign: `center` }}>
          <Grid xs={12} md={4}>
            ...
            <StaticImage
              src="./images/icons/LandX-Kemkominfo.webp"
              height={300}
              quality={95}
              formats={["auto", "webp", "avif"]}
          ...
          <Grid xs={12} md={4}>
            ...
            <StaticImage
              src="./images/icons/LandX-ISO.webp"
              height={300}
              quality={95}
              formats={["auto", "webp", "avif"]}
          ...
          <Grid xs={12} md={4}>
            ...
            <StaticImage
              src="./images/icons/LandX-ALUDI.webp"
              height={300}
              quality={95}
              formats={["auto", "webp", "avif"]}
        ...
        <Grid container spacing={2} style={{ marginTop: `3rem` }}>
          ...
          <Grid xs={12} md={6} style={{ textAlignLast: `left` }}>
            <Link className="footer-icon-link">
              <StaticImage
                src="./images/icons/LandX-Linkedin.svg"
                height={32}
                quality={95}
                formats={["auto", "webp", "avif"]}
                alt="LandX Platform Equity Crowdfunding Indonesia yang akan membantu investasi bisnis jangka panjang anda"
            ...
            <Link className="footer-icon-link">
              <StaticImage
                src="./images/icons/LandX-Facebook.svg"
                height={32}
                quality={95}
                formats={["auto", "webp", "avif"]}
                alt="LandX Platform Equity Crowdfunding Indonesia yang akan membantu investasi bisnis jangka panjang anda"
            ...
            <Link className="footer-icon-link">
              <StaticImage
                src="./images/icons/LandX-Instagram.svg"
                height={32}
                quality={95}
                formats={["auto", "webp", "avif"]}
                alt="LandX Platform Equity Crowdfunding Indonesia yang akan membantu investasi bisnis jangka panjang anda"
